...
import { TrendingUp, Home, Mail, Search, Zap, BookOpen, Lightbulb, ChevronRight } from "lucide-react";
...
const ResearchInnovation = () => {
  ...
  const competencies = [
    { icon: Search, title: "Technical Research", description: "Investigate cutting-edge technologies and methodologies" },
    { icon: Zap, title: "Prototype Development", description: "Transform concepts into working prototypes" },
    { icon: Lightbulb, title: "Innovation & Experimentation", description: "Explore novel approaches to solve problems" },
    { icon: BookOpen, title: "Continuous Learning", description: "Stay updated with industry trends and advancements" },
    { icon: TrendingUp, title: "Industry Trend Analysis", description: "Analyze emerging technologies and their applications" },
  ];
  ...
  const examples = [
    {
      title: "Hybrid Solar Tracking System",
      description: "Designed prototype based on real-world data and efficiency analysis",
      achievements: ["Conducted comprehensive efficiency analysis", "Integrated real-world data into design", "Developed working prototype", "Optimized tracking algorithms"]
    }
  ];
    ...
    <div className="min-h-screen font-sans">
      ...
      <section className="min-h-[50vh] bg-gradient-hero relative overflow-hidden pt-20">
        ...
        <div className="container mx-auto px-4 py-20 relative z-10">
          <div className="flex items-center gap-2 text-sm text-muted-foreground mb-8 animate-fade-in">
            ...
            <ChevronRight className="h-4 w-4" />
            <span className="text-foreground">Research & Innovation</span>
          </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h1 className="font-heading text-4xl md:text-6xl font-bold mb-6 animate-fade-in">
              Research & <span className="bg-gradient-primary bg-clip-text text-transparent">Innovation</span>
            </h1>
            
            <p className="text-xl text-muted-foreground animate-fade-in-up">
              Transforming concepts into working prototypes through continuous research
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <Card className="p-8 bg-gradient-card shadow-lg animate-fade-in-up">
              ...
              <p className="text-lg text-muted-foreground leading-relaxed">
                Research drives innovation — turning concepts into working prototypes. By staying updated with the latest developments in smart energy and IoT through online courses, technical research, and systematic experimentation, I continuously explore new frontiers in electrical engineering and embedded systems.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-20 bg-gradient-hero">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-center mb-12 animate-fade-in">
              Innovation <span className="bg-gradient-primary bg-clip-text text-transparent">Showcase</span>
            </h2>
            ...
            <Card className="p-8 bg-gradient-card shadow-lg animate-fade-in-up">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-muted-foreground leading-relaxed">
                    Exploring AI-based optimization, EV charging networks, and renewable energy control systems to drive the next generation of sustainable energy solutions.
                  </p>
                </div>
              </div>
            </Card>
